...
//
     ...
     * zero.
     */
    private final long mIndexOffset;
...
//
    ...
    public int compareTo(final EfsIndexEndpoint ep)
    {
        ...
        if (retval == 0)
        {
            retval = Long.compare(mIndexOffset, ep.mIndexOffset);
        }
...
//
    ...
    //
         ...
         */
        public Builder indexOffset(final long offset,
