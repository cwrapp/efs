...
//
    ...
    {
        final PerformanceEvent peIn =
            new PerformanceEvent(0, System.nanoTime(), null);
        final ConflationEvent<PerformanceEvent> ce =
            new ConflationEvent<>();
        PerformanceEvent peOut;

        assertThat(ce.isEmpty()).isTrue();
        assertThat(ce.contains(PerformanceEvent.class))
            .isFalse();
